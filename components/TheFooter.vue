    ...
    <footer class="bg-white" aria-labelledby="footer-heading">
      ...
      <div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        <div class="xl:grid xl:grid-cols-3 xl:gap-8">
          <LogosBasicBlack class="col-span-1" />
          <div class="col-span-2 flex gap-20">
              <div>
                <ArticlesContactPerson job="Festivalsjef/daglig leder" name="Simen Korneliussen" phone="(+47) 984 61 643" email="simen@villvillvest.no" />
              </div>
              <div class="mt-10 md:mt-0">
                <ArticlesContactPerson job="Konferanseansvarlig" name="Inni Mowinckel" phone="(+47) 936 34 242" email="inni@brak.no" />
              </div>
          </div>
        </div>
        <!--
        ...
        <div class="mt-8 border-t border-gray-900/10 pt-8 md:flex md:items-center md:justify-between">
          ...
          <p class="mt-8 text-xs leading-5 text-gray-500 md:order-1 md:mt-0">&copy; 2023 Vill Vill Vest</p>
        </div>
      </div>
    </footer>
  </template>